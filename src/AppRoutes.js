...
function AppRoutes({ profileCreated, setProfileCreated, handleProfileClick, profileData, setProfileData }) {
  ...
  return (
    ...
    <Route
    path="/"
    element={profileCreated ? <Home user={user} /> : <CreateUserProfile
    user={user} setProfileCreated={setProfileCreated} />} />
